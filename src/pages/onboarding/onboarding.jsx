                ...
                <div className="onboarding-wrapper">
                    <div className="onboarding-header">
                        ...
                        <div className="header-txt">
                            <p>
                                Welcome to GardenGenius, your gardening companion app! Whether you&apos;re a seasoned
                                green
                                thumb or just starting out, this app is here to help you plan and maintain your dream
                                garden
                                with ease.
                            </p>
                        </div>
                    ...
                    <div className="onboarding-content">
                        <p>With our user-friendly interface and comprehensive plant database, you can effortlessly
                            ...
                            finds
                            for future reference. From colorful blooms to lush foliage, our app has everything you need
                            to
